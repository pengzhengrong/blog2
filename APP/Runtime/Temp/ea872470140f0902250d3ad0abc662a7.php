<?php
//000000000000a:11:{i:0;a:4:{s:2:"id";s:2:"73";s:5:"title";s:11:"优化Mysql";s:7:"content";s:1950:"<p>优化Mysql之前,首先进行Sql分析</p><pre class="brush:sql;toolbar:false;">1.&nbsp;profiling&nbsp;查看sql执行的步骤
...
不能使用索引的情况</pre><p><br/></p>";s:7:"created";s:10:"1466416414";}i:1;a:4:{s:2:"id";s:2:"72";s:5:"title";s:9:"分析sql";s:7:"content";s:4147:"<p>优化sql之前,先要做一次分析sql.了解当前的sql是否已足够优化并且针对不足采取优化措施.</p><p>1. show status</p><pre class="brush:sql;toolbar:false">通过show&nbsp;status&nbsp;命令了解各种sql&nbsp;的执行频率
...
可以使用&nbsp;explain&nbsp;partitions&nbsp;显示sql&nbsp;在哪个分区进行查找.</pre><p><br/></p>";s:7:"created";s:10:"1466061924";}i:2;a:4:{s:2:"id";s:2:"69";s:5:"title";s:12:"分区管理";s:7:"content";s:4882:"<p>Mysql 5.1提供了添加,删除,重定义,合并,拆分分区命令.这些命令都可以通过alter table 命令执行.</p><p>Range分区和List分区</p><pre class="brush:sql;toolbar:false">这两个分区命令比较类似
--&nbsp;增加
...
--&nbsp;增加分区
alter&nbsp;table&nbsp;test3&nbsp;add&nbsp;partition&nbsp;partitions&nbsp;8;</pre><p><br/></p>";s:7:"created";s:10:"1465962227";}i:3;a:4:{s:2:"id";s:2:"68";s:5:"title";s:9:"子分区";s:7:"content";s:894:"<p>子分区</p><pre class="brush:sql;toolbar:false">子分区是对分区的再分区.
...
在这里进行了8=4*2个分区.
复合分区用于保存非常大量的数据记录.</pre><p><br/></p>";s:7:"created";s:10:"1465899412";}i:4;a:4:{s:2:"id";s:2:"67";s:5:"title";s:9:"Key分区";s:7:"content";s:747:"<p>Key分区</p><pre class="brush:sql;toolbar:false">(1)&nbsp;常规Key分区
...
注意:&nbsp;key分区不能使用&nbsp;alter&nbsp;table&nbsp;drop&nbsp;primary&nbsp;key;来删除主键.</pre><p><br/></p>";s:7:"created";s:10:"1465892673";}i:5;a:4:{s:2:"id";s:2:"66";s:5:"title";s:10:"Hash分区";s:7:"content";s:1484:"<p>Hash分区</p><pre class="brush:sql;toolbar:false">主要作用:&nbsp;分散热点读,确保数据在预先确定个数的分区中尽可能平均分布.
(1)&nbsp;常规Hash分区
...
最后,当N&gt;=num,N=N&amp;(V-1);</pre><p><br/></p>";s:7:"created";s:10:"1465891794";}i:6;a:4:{s:2:"id";s:2:"65";s:5:"title";s:13:"Columns分区";s:7:"content";s:949:"<p>Column分区</p><pre class="brush:sql;toolbar:false">在5.5版本中新增
...
(1,10)&nbsp;&lt;&nbsp;(10,10)
(a&lt;10)&nbsp;or&nbsp;((a=10)and(b&lt;10))</pre><p><br/></p>";s:7:"created";s:10:"1465871156";}i:7;a:4:{s:2:"id";s:2:"64";s:5:"title";s:10:"List分区";s:7:"content";s:1442:"<p>List分区<br/></p><pre class="brush:sql;toolbar:false">List分区类似Range分区,但是不同的是无需像Range那样声明特定的顺序.
...
);</pre><p><br/></p>";s:7:"created";s:10:"1465869516";}i:8;a:4:{s:2:"id";s:2:"62";s:5:"title";s:11:"Range分区";s:7:"content";s:2966:"<p>Range分区<br/></p><pre class="brush:sql;toolbar:false">create&nbsp;&nbsp;table&nbsp;`blog`&nbsp;(
...
&nbsp;&nbsp;&nbsp;&nbsp;例如:&nbsp;explain&nbsp;partitions&nbsp;select&nbsp;*&nbsp;from&nbsp;blog&nbsp;where&nbsp;cat_id&nbsp;&gt;25;</pre>";s:7:"created";s:10:"1465806442";}i:9;a:4:{s:2:"id";s:2:"61";s:5:"title";s:11:"mysql分区";s:7:"content";s:3545:"<p>对于数据量较大的数据表,可以进行分区处理.</p><p>优点</p><pre class="brush:sql;toolbar:false">1.&nbsp;和单个磁盘或者文件系统分区相比,可以存储更多数据
