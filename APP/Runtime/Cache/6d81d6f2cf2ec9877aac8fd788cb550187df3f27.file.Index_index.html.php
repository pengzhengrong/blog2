<?php /* Smarty version Smarty-3.1.6, created on 2016-06-19 22:57:12
         compiled from "./APP/Home/View/Index_index.html" */ ?>
<?php /*%%SmartyHeaderCode:429841467576513b3da80b1-71660180%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6d81d6f2cf2ec9877aac8fd788cb550187df3f27' => 
    array (
      0 => './APP/Home/View/Index_index.html',
      1 => 1466348228,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '429841467576513b3da80b1-71660180',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_576513b3e7a43',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_576513b3e7a43')) {function content_576513b3e7a43($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("Common/header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>"blog"), 0);?>
...
<div class="all-elements">
  <?php echo $_smarty_tpl->getSubTemplate ("Common/left.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
    ...
    <div class="header">
        ...
        <a id="change-color" href="javascript:" class="open-mail"><i class="fa fa-envelope-o"></i></a>
...
/images/pictures/3.jpg" class="responsive-image" alt="img">
                </div>
                <div>
                    <div class="overlay"></div>
                    ...
                    <img src="<?php echo @__PUBLIC__;?>
/images/pictures/5.jpg" class="responsive-image" alt="img">
                </div>
                <div>
                    <div class="overlay"></div>
                    ...
                    <img src="<?php echo @__PUBLIC__;?>
/images/pictures/6.jpg" class="responsive-image" alt="img">
                </div>
            </div>
        </div>
            ...
            <div class="container no-bottom">
                ...
                <div class="one-half-responsive">
                    <p class="thumb-left no-bottom">
                        <img src="<?php echo @__PUBLIC__;?>
/images/pictures/1s.jpg" alt="img">
                ...
                <div class="one-half-responsive last-column">        
                    <p class="thumb-right no-bottom">
                        <img src="<?php echo @__PUBLIC__;?>
/images/pictures/2s.jpg" alt="img">
                ...
                <div class="one-half-responsive">
                    <p class="thumb-left no-bottom">
                        <img src="<?php echo @__PUBLIC__;?>
/images/pictures/3s.jpg" alt="img">
                ...
                <div class="one-half-responsive last-column">        
                    <p class="thumb-right no-bottom">
                        <img src="<?php echo @__PUBLIC__;?>
/images/pictures/4s.jpg" alt="img">
...
/images/pictures/4s.jpg" alt="img">
                    ...
                    <div>
                        <div class="staff-item">
                            <img src="<?php echo @__PUBLIC__;?>
/images/pictures/5s.jpg" alt="img">
                            <h4>Victor Leaf</h4>
                            <em>Front End Developer</em>
                            <strong>We love quotes, and sometimes it's annoying to see tons of them that you need to scroll to!</strong>
                    ...
                    <div>
                        <div class="staff-item">
                            <img src="<?php echo @__PUBLIC__;?>
/images/pictures/6s.jpg" alt="img">
                            <h4>Snow White</h4>
                            <em>Business Manager</em>
                            <strong>We love quotes, and sometimes it's annoying to see tons of them that you need to scroll to!</strong>
            ...
            <div class="container">
                <div class="one-half-responsive">
                    <img src="<?php echo @__PUBLIC__;?>
/images/mobile1.png" alt="img" class="responsive-image">
                </div>
                <div class="one-half-responsive last-column">
            ...
            <ul class="gallery square-thumb">
                <li><a class="swipebox" href="<?php echo @__PUBLIC__;?>
/images/pictures/1.jpg" title="An awesome gallery!"><img src="<?php echo @__PUBLIC__;?>
/images/pictures/1s.jpg" alt="img" /></a></li>
                <li><a class="swipebox" href="<?php echo @__PUBLIC__;?>
/images/pictures/2.jpg" title="An awesome gallery!"><img src="<?php echo @__PUBLIC__;?>
/images/pictures/2s.jpg" alt="img" /></a></li>
                <li><a class="swipebox" href="<?php echo @__PUBLIC__;?>
/images/pictures/3.jpg" title="An awesome gallery!"><img src="<?php echo @__PUBLIC__;?>
/images/pictures/3s.jpg" alt="img" /></a></li>
                <li><a class="swipebox" href="<?php echo @__PUBLIC__;?>
/images/pictures/4.jpg" title="An awesome gallery!"><img src="<?php echo @__PUBLIC__;?>
/images/pictures/4s.jpg" alt="img" /></a></li>
                <li><a class="swipebox" href="<?php echo @__PUBLIC__;?>
/images/pictures/5.jpg" title="An awesome gallery!"><img src="<?php echo @__PUBLIC__;?>
/images/pictures/5s.jpg" alt="img" /></a></li>
                <li><a class="swipebox" href="<?php echo @__PUBLIC__;?>
/images/pictures/6.jpg" title="An awesome gallery!"><img src="<?php echo @__PUBLIC__;?>
/images/pictures/6s.jpg" alt="img" /></a></li>
                <li><a class="swipebox" href="<?php echo @__PUBLIC__;?>
/images/pictures/7.jpg" title="An awesome gallery!"><img src="<?php echo @__PUBLIC__;?>
/images/pictures/7s.jpg" alt="img" /></a></li>
                <li><a class="swipebox" href="<?php echo @__PUBLIC__;?>
/images/pictures/8.jpg" title="An awesome gallery!"><img src="<?php echo @__PUBLIC__;?>
/images/pictures/8s.jpg" alt="img" /></a></li>
                <li><a class="swipebox" href="<?php echo @__PUBLIC__;?>
/images/pictures/1.jpg" title="An awesome gallery!"><img src="<?php echo @__PUBLIC__;?>
/images/pictures/1s.jpg" alt="img" /></a></li>
                <li><a class="swipebox" href="<?php echo @__PUBLIC__;?>
